...
public class YelpAPI {
    ...
    //TODO: enter your developer keys
    private static final String CONSUMER_KEY = "CONSUMER_KEY_HERE";
    private static final String CONSUMER_SECRET = "CONSUMER_SECRET_HERE";
    private static final String TOKEN = "TOKEN_HERE";
    private static final String TOKEN_SECRET = "SECRET_TOKEN_HERE";
    ...
    private String sendRequestAndGetResponse(OAuthRequest request) {
        ...
        System.out.println("Done. Rendering results now.");
    ...
    private static class YelpAPICLI {
        ...
        public String term = "food";

        @Parameter(names = { "-l","--location" }, description = "Location to be Queried")
        public String location = "Timbuktu";
    }
